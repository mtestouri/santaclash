...
import 'package:santaclash/menus/host.dart';
...
class _IdleGSantaState extends State<IdleGSanta> with TickerProviderStateMixin{
  ...
  Widget frameNeeded(AnimationController frameNbr){
    ...
    if(frameNbr.value>=0 && frameNbr.value<1) {
      ...
      return Image.asset('assets/images/fighters/green_santaclaus/idle_l_2.png');
    }
    else if(frameNbr.value>=2 && frameNbr.value<3) {
      return Image.asset('assets/images/fighters/green_santaclaus/idle_l_3.png');
    }
    else if(frameNbr.value>=3 && frameNbr.value<4) {
      return Image.asset('assets/images/fighters/green_santaclaus/idle_l_4.png');
    }
    else {
      return Image.asset('assets/images/fighters/green_santaclaus/idle_l_5.png');
    }
