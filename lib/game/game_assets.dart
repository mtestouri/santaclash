...
class GameAssetsFactory {
  ...
  static GameAssets map1() {
    ...
    // fighters
    Fighter player = SantaClaus(Fighter.PLAYER, 30, 35);
    Fighter opponent = SantaClaus(Fighter.OPPONENT, 70, 35);
  ...
  static GameAssets map2() {
    ...
    // fighters
    Fighter player = Cyclope(Fighter.PLAYER, 18, 26);
    Fighter opponent = SantaClaus(Fighter.OPPONENT, 78, 34);
